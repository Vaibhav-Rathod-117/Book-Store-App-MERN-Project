        ...
        <div className="w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-4">
                ...
                <input {...register("email", { required: true })} type="email" name="email" id="email" placeholder="Enter Email Address" className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow" />
              </div>
              <div className="mb-4">
            ...
            <p className="align-baseline font-medium mt-4 text-sm">Have not an account? Please <Link to="/register" className="text-blue-500 hover:text-blue-700">Register</Link></p>
            <div className="mt-4">
            ...
            <p className="mt-5 text-center text-gray-500 text-xs">&copy; Book store. All rights reserved.</p>
        </div>
    </div>
  )
}
